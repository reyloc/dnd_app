Flaw.create([
  ...
  {:background_id => 4,
   :description => "I'll do anything lo win fame and renown."
  },
  {:background_id => 4,
  ...
  {:background_id => 8,
   :description => "I hide a truly scandalous secret that would ruin my family forever."
  },
  {:background_id => 8,
  ...
  {:background_id => 9,
   :description => "Don't expect me to save those who can't save themselves. It is nature's way that the string thrive and the weak perish."
  },
  {:background_id => 10,
  ...
  {:background_id => 10,
   :description => "I speak without really thinking through invariably insulting others."
  },
  {:background_id => 10,
  ...
  {:background_id => 11,
   :description => "I'll say anything lo avoid having to do extra work."
  },
  {:background_id => 11,
  ...
  {:background_id => 11,
   :description => "My pride will probably lead lo my destruction."
  },
  {:background_id => 12,
