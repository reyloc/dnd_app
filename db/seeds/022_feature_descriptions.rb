FeatureDescription.create([
  ...
  {:feature_id => 3,
   :description => "You have a reliable and trustworthy contact who acts as your liaison lo a network of other criminals. You know how to get messages to and from your contact, even over great distances; specifically, you know the local messengers, corrupt caravan masters, and seedy sailors who can deliver messages for you."
  },
  {:feature_id => 4,
  ...
  {:feature_id => 14,
   :description => "If your character has a noble background, you may select this background feature instead of Position of Privilege."
  },
  {:feature_id => 14,
  ...
  {:feature_id => 15,
   :description => "If your character has a sailor background, you may select this background feature instead of Ship's Passage."
  },
  {:feature_id => 15,
