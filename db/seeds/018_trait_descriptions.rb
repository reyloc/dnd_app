TraitDescription.create([
  ...
  {:trait_id => 2,
   :description => "After you use your breath weapon, you can’t use it again until you com plete a short or long rest."
  },
  {:trait_id => 3,
  ...
  {:trait_id => 44,
   :description => "When you create a device, choose one of the following from the table."
  },  
  {:trait_id => 45,
